...
def main():
    ...
    ap.add_argument("--data-root",type=Path,default=PROJECT_ROOT / "E题数据" / "E题数据",help="competition E题数据 root")
    ap.add_argument("--out",type=Path,default=PROJECT_ROOT / "outputs" / "问题1_全量特征结果")
