...
def train(args):
    ...
    config = {
        "experiment": "full_mosei_cross_modal_token_interaction",
        ...
        "loss": f"frequency weighted CE power={args.weight_power:g}, label_smoothing={args.label_smoothing:g}, 0.6 SmoothL1, ordinal={args.ordinal_weight:g}, supervised_contrastive={args.supcon_weight:g}, distillation_weight={args.distill_weight:g}",
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for start in range(0, len(order), args.batch_size):
            ...
            ) + 0.6 * F.smooth_l1_loss(regression, r)
