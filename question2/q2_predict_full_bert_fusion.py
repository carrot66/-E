...
if __name__ == '__main__':
    ...
    parser.add_argument('--text-delta',type=Path,default=ROOT/'outputs/question2/问题2_完整数据BERT文本编码实验/问题2_完整数据BERT文本编码器_最优delta.pt')
    ...
    parser.add_argument('--out',type=Path,default=ROOT/'outputs/question2/问题2_监督BERT附件3预测')
