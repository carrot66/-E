...
if __name__ == '__main__':
    ...
    parser.add_argument('--text-delta', default=ROOT / 'outputs/question2/问题2_完整数据BERT文本编码实验/问题2_完整数据BERT文本编码器_最优delta.pt')
    parser.add_argument('--fusion-checkpoint', default=ROOT / 'outputs/question2/问题2_完整MOSEI训练实验/完整数据_缺失蒸馏学生_种子2026.pt')
    parser.add_argument('--annex3-dir', default=ROOT / 'E题数据/E题数据/附件3-模态缺失特征样本/对齐版本')
    parser.add_argument('--out', default=ROOT / 'outputs/question2/问题2_固定文本融合附件3结果')
